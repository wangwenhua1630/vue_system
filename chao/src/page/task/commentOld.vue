...
<script>
    ...
    export default {
        ...
        mounted(){
          commentList('','','','','','','','','','','',2,1,10).then(response=>{
              var data=response
              if(data.msg==1){
                this.tai=data.types;
        ...
        methods:{
          ...
          search(){
            ...
            if(this.form.date==null){
              ...
              commentList(this.form.tai,result,results,resultss,date1,date2,this.form.state,this.form.states,this.form.account,this.form.storeName, resultsss,2,this.currentPage,10).then(response=>{
                  var data=response
                  if(data.msg==1){
                    this.tableData=data.page.result
                    this.totalPages=data.page.totalRow
          ...
          CurrentChange(e){
            ...
            if(this.form.date==null){
              ...
              commentList(this.form.tai,result,results,resultss,date1,date2,this.form.state,this.form.states,this.form.account,this.form.storeName,resultsss,2,e,10).then(response=>{
                  var data=response
                  if(data.msg==1){
                    this.tableData=data.page.result
                    this.totalPages=data.page.totalRow
