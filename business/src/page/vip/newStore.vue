        ...
        <div class="all-box">
          <div class="recharge-info">
            ...
            <div class="info-box">
              ...
              请新商家添加以下<span class='rechare-span'>客服微信</span>以及<span class='rechare-span'>QQ</span>，添加信息<span class='rechare-span'>备注</span>为店铺名称:
              <p>客服微信：rwghqq123 / LLL_crystal  / 18049297459</p>
              <p>客服Q Q：3250150163</p>
            </div>
          </div>
          <el-form ref="form" :model="form"  :rules="rules" label-width="130px" label-position='left' size='small' >
            <el-row>
              <el-col>
                <el-form-item  label="店铺平台" prop='types' class='form-item'>
                  <el-radio-group v-model="form.types" >
                    <!--<el-radio :label="1">淘宝</el-radio>-->
                    <!--<el-radio :label="2">天猫</el-radio>-->
                    <el-radio :label="item.id" v-for="(item,index) in tai" :key="index">{{item.name}}</el-radio>
                  </el-radio-group>
                </el-form-item>
                ...
                <el-form-item label="店铺推广状态：" class='form-item' prop='tui' v-if="this.form.types==1">
    ...
    data(){
      ...
      return{
        ...
        rules:{
          ...
          types:[{required:true,trigger:'change',message: '请选择店铺平台'}],
