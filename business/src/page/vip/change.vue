        ...
        <div class="all-box">
          ...
          <div class="recharge-pay">
            ...
            <el-table  ref="multipleTable" :data="tableData" tooltip-effect="dark"  style="width: 100%"  border  header-row-class-name="table-header">
              <el-table-column label="平台类型"  header-align="center" show-overflow-tooltip>
                <template slot-scope="scope">
                  <p>{{scope.row.adminStoreType.name}}</p>
                </template>
              </el-table-column>
...
<script>
   import {storeListDan,tiao,danSearch} from '../../api/vip';
  export default {
    data(){
      return {
        tableData:[],
    ...
    methods: {
      ...
      tiao(index){
        this.danList=this.tableData[index];
