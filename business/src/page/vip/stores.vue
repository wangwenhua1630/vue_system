        ...
        <el-col>
          <div class="store-inner">
            ...
            <el-table  ref="multipleTable" :data="tableData" tooltip-effect="dark"  style="width: 100%"   header-row-class-name="table-header" border >
              ...
              <el-table-column label="所属平台" header-align="center">
                <template slot-scope="scope">
        ...
        <el-row class="contain row-bg taskInfos" type="flex"  justify="center">
          <el-col>
            <ul class="loading-tips loading-ge">
              <li class='loading-list'><label class='alert-label' >店铺性质：</label>{{suoName}}</li>
    ...
    export default {
      ...
      methods:{
        ...
        look(index,row,type){
          ...
          this.suoName=this.tableData[index].adminStoreType.name;
