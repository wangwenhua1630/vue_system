    ...
    export default {
        ...
        methods:{
          ...
          search(){
            ...
            findHandTaskInfo1(1,10,result,results,resultss,date1,date2,goodStatus,addStatus).then(response => {
              const data = response;
               if(data.msg==1){
                 this.tableData=data.page.result
                  for(var i=0;i<data.page.result.length;i++){
          ...
          CurrentChange(e){
            ...
            if(this.form.state==1||this.form.state==2||this.form.state==3||this.form.state==4||this.form.state==5||this.form.state==6){
             ...
             findHandTaskInfo(e,10,result,results,resultss,date1,date2,goodStatus,addStatus).then(response => {
              const data = response;
               if(data.msg==1){
                  this.tableData=data.page.result
                  for(var i=0;i<data.page.result.length;i++){
